...
| F021 | 右侧面板重设计【**Reopened 2026-04-22 — Phase 6 上下文窗口/Seal 阈值齿轮可配 + fillRatio 观测**】| in-progress | 黄仁勋 | internal | [F021](features/F021-right-panel-redesign.md) |
<!-- 新 Feature 在此行上方添加 -->
