...
> **后续纠偏（B045）**：B044 的“周一不带 GitHub”把新闻日期范围错误扩大成栏目删除，并导致 07-27 实发从五栏缩成三栏；Digg 的持续 challenge 429 也不能靠一次重试恢复。现行合同以 [B045](B045-weekend-roundup-section-regression.md) 为准：周一新闻仍严格限周六/周日，但 GitHub 四榜作为状态快照保留、五栏固定、Digg 等量替换为 Lobsters。下文保留 B044 当时的历史诊断与验证事实，不再作为现行栏目合同。
