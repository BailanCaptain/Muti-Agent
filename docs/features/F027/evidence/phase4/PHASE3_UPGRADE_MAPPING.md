...
| **AC-P3-8 b** Inspector unresolved UI | CONDITIONAL_PASS (推 Phase 4) | **AC-P4-9 c** | 场景 3 step 3.4-3.5 | `evidence/phase3/AC-P3-8/screenshots/` 加：Coverage section 非空 + click trigger alert (Day 13 占位; 真 supersede/reject UI 推 F028) | ⏳ 待 walkthrough；F028 follow-up 已记 |
