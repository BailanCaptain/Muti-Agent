...
## Manual Acceptance (P3.T4)

> 2026-04-11 小孙手动走查的 8 条 E2E 清单，归档自 `F002-p3-e2e-checklist.md`。已由 AC5 小孙授权跳过手动验证（见 `3f70f2a docs(F003): archive — AC5 由小孙授权跳过前端手动验证`），但清单内容作为未来回归参考保留。
